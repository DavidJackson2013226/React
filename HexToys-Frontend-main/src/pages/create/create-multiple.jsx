...
import { addMultiItem, createMultipleCollection } from "../../utils/contracts";
...
function CreateMultiple(props) {
    ...
    function fetchCollections() {
        ...
        axios.get(`${process.env.REACT_APP_API}/collection?ownerAddress=${account}&chainId=${chainId}&type=multi&sortDir=asc`)
            .then((res) => {
                console.log("res: ", res);
    ...
    return (
        <div>
            <Header {...props} />
            {
                account && active &&
                <Element.Container>
                    <Element.Title><h1>Create Multiple NFT</h1></Element.Title>
                    <Element.UploadField>
                    ...
                    <Element.SelectCollection>
                        ...
                        <Element.Collections>
                            <Element.collection onClick={() => setShowCreateCollectionDlg(true)}>
                                ...
                                <Element.CollectionType>PRC-1155</Element.CollectionType>
                                </div>
                            </Element.collection>
                            {
                    ...
                    <Element.Form>
                        ...
                        <Element.Field>
                            <Element.Label>Supply <span>(Number of Copies)</span></Element.Label>
                            <Element.Input value={supply} type={"number"} onChange={event => setSupply(Math.floor(event.target.value))} />
                        </Element.Field>
